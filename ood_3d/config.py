...
combined_policy_cfg = {
    ...
    'recovery_ckpt': '/home/george/diffusion_policy/data/outputs/2024.09.13/16.22.01_train_diffusion_unet_lowdim_obsact_square_lowdim/checkpoints/epoch=1400-train_action_mse_error=0.000.ckpt',
